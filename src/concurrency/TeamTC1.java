...
class TeamTC1 implements Runnable {
    ...
    String[] colors = {ConsoleColors.BLACK, ConsoleColors.RED, ConsoleColors.GREEN, ConsoleColors.YELLOW, ConsoleColors.BLUE, ConsoleColors.PURPLE, ConsoleColors.CYAN, ConsoleColors.WHITE, ConsoleColors.RED_BOLD, ConsoleColors.GREEN_BOLD, ConsoleColors.BLUE_BOLD, ConsoleColors.PURPLE_BOLD};
